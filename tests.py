...
gspc = yf.download('^GSPC', start="2019-12-30", end="2021-10-01")
gspc = gspc['Adj Close']
gspc.dropna(inplace=True)
gspc = gspc.loc[gspc.index.isin(['2019-12-31', '2020-03-31', '2020-06-30', '2020-09-30', '2020-12-31', '2021-03-31', '2021-06-30', '2021-09-30'])]
gspc.to_csv('Price data/gspc.csv')
